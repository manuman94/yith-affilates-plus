...
Installing "Yith Affiliates Plus" can be done either by searching for "Yith Affiliates Plus" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
